                        ...
                        <div className="w-full flex-1 ">
                            ...
                            <div className="mx-auto max-w-xs">
                                <input
                                    ...
                                    type="email" value={formData.email} name='email' onChange={(e) => setFormData({ ...formData, email: e.target.value })} placeholder="Email" />
                                <input
                                    className="w-full px-8 py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white mt-5"
                                    type="password" name='password' value={formData.password} onChange={(e) => setFormData({ ...formData, password: e.target.value })} placeholder="Password" />
                                <button
                                    onClick={handleLogin}
                                ...
                                <p className='mt-2'>
                                    <Link to={'/Sign-up'} className='text-blue-600 underline '>I Have Not an Account ?</Link>
                                </p>
                            </div>
                        </div>
                    </div>
